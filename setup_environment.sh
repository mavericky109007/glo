...
sudo apt install -y libpcsclite-dev libtalloc-dev libortp-dev libsctp-dev \
    ...
    libfontconfig1-dev libxrender-dev libpulse-dev g++ automake autoconf \
    ...
    python3-zmq libgps-dev libgps23 gpsd gpsd-clients python3-gps \
    python3-pip tmux
